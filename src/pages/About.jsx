...
const Section = ({ title, description, imgSrc, imgAlt, imgFirst }) => {
    return (
        <section className="py-12 px-6 md:flex md:justify-between md:items-center border-b border-gray-200">
            <div
                className={`flex flex-col-reverse ${imgFirst ? "md:flex-row-reverse" : "md:flex-row"} md:w-full`}
            >
                ...
                <div className="md:w-1/2 md:pl-6">
                    ...
                    <p className="text-lg text-gray-600 mb-4 leading-relaxed mr-2">
                        {description}
                    </p>
                </div>
            </div>
...
const About = () => {
    ...
    useEffect(() => {
        fetch(
            "https://ngo-backend-om-pagariyas-projects.vercel.app/aboutus/getaboutus/5",
        )
    ...
    useEffect(() => {
        fetch(
            "https://ngo-backend-om-pagariyas-projects.vercel.app/aboutus/getaboutus/2",
        )
            .then((response) => response.json())
    ...
    useEffect(() => {
        fetch(
            "https://ngo-backend-om-pagariyas-projects.vercel.app/aboutus/getaboutus/3",
        )
            .then((response) => response.json())
    ...
    useEffect(() => {
        fetch(
            "https://ngo-backend-om-pagariyas-projects.vercel.app/aboutus/getaboutus/4",
        )
            .then((response) => response.json())
        ...
        <div className="bg-gray-50">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <Section
                    ...
                    imgSrc={
                        missionData.image ||
                        "https://www.hdfindia.org/assets/img/mission.jpg"
                    }
                    imgAlt="Mission"
                    imgFirst={true}
                />
                ...
                <Section
                    ...
                    imgSrc={
                        visionData.image || "https://www.hdfindia.org/assets/img/vision.jpg"
                    }
                    imgAlt="Vision"
                    imgFirst={false}
                />
